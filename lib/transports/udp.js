...
// var nicAddresses = require('./addresses/nic-nodejs')
// var nicAddresses = require('./addresses/nic-chrome')
var nicAddresses = require('./addresses/nic-cordova')
...
UdpTransport.prototype.listen = function (listeningInfo, onSuccess, onFailure) {
  ...
  this._socket.bind(port, address, function () {
    ...
    self._log.debug('udp socket bound, listening on address:' + address + ', port:' + port)
