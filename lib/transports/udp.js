...
UdpTransport.prototype.connect = function (peerConnectionInfo, onSuccess, onFailure) {
  ...
  var sendSynPacket = function () {
    ...
    stream._sendSignalingMessage(SignalingMessage.TYPE.SYN)
  }
...
UdpTransport.prototype._processIncomingDgram = function (message) {
  var stream
  switch (message.type) {
    case SignalingMessage.TYPE.SYN:
      ...
      if (this._acceptIncomingConnections) {
        ...
        stream._sendSignalingMessage(SignalingMessage.TYPE.SYN_ACK)
      } else {
        this._log.debug('not accepting new connections -- dropping SYN on the floor')
      }
      // done
      break
    case SignalingMessage.TYPE.SYN_ACK:
    ...
    case SignalingMessage.TYPE.FIN:
      ...
      // done
      break
    case SignalingMessage.TYPE.RST:
