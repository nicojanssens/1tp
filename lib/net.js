...
var Socket = function (transports, args) {
  if (!(this instanceof Socket)) {
    return new Socket(transports)
  }
  // init
  this._args = merge(Object.create(Socket.DEFAULTS), args)
  // logging
  this.setLogger(winston)
  // verify transports
...
var createConnection = function () {
  ...
  // second optional argument -> args
  var args = arguments[2]
  if (args === undefined || typeof transports !== 'object') {
    args = {}
  }
  // last optional argument -> callback
