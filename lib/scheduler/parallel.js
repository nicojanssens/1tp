...
ParallelScheduler.prototype.connectP = function (connectionAttempts) {
  ...
  return Q.any(connectPromises)
    .then(function (stream, peerConnectionInfo) {
      // TODO: pre-empt remaining connection attempts
      var remainingConnections = connectionAttempts.filter(function (transportSpecs) {
        return transportSpecs === stream._peerConnectionInfo
      })
      return stream
    })
}
