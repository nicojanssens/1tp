...
function ProxyStream () {
  ...
  // set stream id
  this._id = myUtils.generateStreamId()
...
ProxyStream.prototype.connectStream = function (stream) {
  if (stream === undefined) {
    var undefinedStreamError = 'cannot connect to undefined stream'
    this._log.error(undefinedStreamError)
    this._error(undefinedStreamError)
  }
